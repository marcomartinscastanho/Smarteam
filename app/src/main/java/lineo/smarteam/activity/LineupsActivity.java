...
public class LineupsActivity extends Activity implements View.OnClickListener {
    ...
    private Integer lineupsCalculationComplexity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setActionBarTitle();
        setLayout();
        new GenerateLineups().execute(lineupsCalculationComplexity);
    }
    ...
    private void getIntentExtras(){
        ...
        lineupsCalculationComplexity = 2 * (int) Math.exp(2 * selectedPlayersIndexList.size() / 3);
    }
    ...
    private class GenerateLineups extends AsyncTask<Integer, Integer, String> {
        ProgressBar progressBar;
        @Override
        protected void onPreExecute() {
            super.onPreExecute();
            progressBar = findViewById(R.id.progressBar);
            progressBar.setMax(lineupsCalculationComplexity);
            progressBar.setVisibility(View.VISIBLE);
            progressBar.setProgress(0);
        }

        @Override
        protected String doInBackground(Integer... complexity) {
            class Player{
